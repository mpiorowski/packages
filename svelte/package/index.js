...
/* src/lib/button.svelte generated by Svelte v3.49.0 */
...
function create_if_block$1(ctx) {
	...
	return {
		c() {
			i = element("i");
			attr(i, "class", "fa-solid fa-spinner fa-spin-pulse mr-2");
		},
		m(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*submitting*/ ctx[3] && create_if_block$1();
	...
	return {
		c() {
			...
			attr(button, "form", /*form*/ ctx[0]);
			attr(button, "type", /*type*/ ctx[2]);

			attr(button, "class", button_class_value = 'transition h-9 focus:outline-none text-gray-50 focus:ring-2 font-bold rounded-lg text-sm px-4 py-2 text-center inline-flex items-center justify-center' + (/*style*/ ctx[1] === 'green'
			? ' bg-teal-600 hover:bg-teal-700  focus:ring-teal-300'
			: '') + (/*style*/ ctx[1] === 'red'
			? ' bg-red-600 hover:bg-red-700  focus:ring-red-300'
			: '') + (/*style*/ ctx[1] === 'ghost'
			? ' bg-sky-700 hover:bg-sky-600  focus:ring-sky-300'
			: ''));

			button.disabled = button_disabled_value = /*submitting*/ ctx[3] || /*disabled*/ ctx[4];
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*style*/ 2 && button_class_value !== (button_class_value = 'transition h-9 focus:outline-none text-gray-50 focus:ring-2 font-bold rounded-lg text-sm px-4 py-2 text-center inline-flex items-center justify-center' + (/*style*/ ctx[1] === 'green'
			? ' bg-teal-600 hover:bg-teal-700  focus:ring-teal-300'
			: '') + (/*style*/ ctx[1] === 'red'
			? ' bg-red-600 hover:bg-red-700  focus:ring-red-300'
			: '') + (/*style*/ ctx[1] === 'ghost'
			...
			if (!current || dirty & /*submitting, disabled*/ 24 && button_disabled_value !== (button_disabled_value = /*submitting*/ ctx[3] || /*disabled*/ ctx[4])) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	return [form, style, type, submitting, disabled, $$scope, slots, click_handler];
}
...
/* src/lib/input.svelte generated by Svelte v3.49.0 */
...
function create_if_block(ctx) {
	let t_1_value = /*$t*/ ctx[7](/*error*/ ctx[2]) + "";
	let t_1;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*$t, error*/ 132 && t_1_value !== (t_1_value = /*$t*/ ctx[7](/*error*/ ctx[2]) + "")) set_data(t_1, t_1_value);
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*required*/ ctx[3] && create_if_block_1();
	...
	return {
		c() {
			...
			attr(label_1, "class", "block mb-1 text-sm font-medium h-5 ");
			...
			attr(input, "class", input_class_value = `transition h-9 shadow-sm block w-full px-3.5 py-1.5 text-sm rounded-md border focus:ring-2 focus:ring-sky-300 border-gray-300 text-gray-900 bg-gray-50
  ${/*error*/ ctx[2]
			? 'border-red-800 text-red-500 bg-red-100'
			: ''}
  ${/*disabled*/ ctx[4] ? 'bg-gray-200' : ''}`);

			attr(p, "class", "mt-1 h-5 text-sm text-red-400 font-bold");
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*error, disabled*/ 20 && input_class_value !== (input_class_value = `transition h-9 shadow-sm block w-full px-3.5 py-1.5 text-sm rounded-md border focus:ring-2 focus:ring-sky-300 border-gray-300 text-gray-900 bg-gray-50
  ${/*error*/ ctx[2]
			? 'border-red-800 text-red-500 bg-red-100'
			: ''}
  ${/*disabled*/ ctx[4] ? 'bg-gray-200' : ''}`)) {
...
function instance($$self, $$props, $$invalidate) {
	let $t;
	component_subscribe($$self, Y, $$value => $$invalidate(7, $t = $$value));
	let { label } = $$props;
	let { value } = $$props;
	let { error = '' } = $$props;
	let { type = 'text' } = $$props;
